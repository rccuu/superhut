...
- 补充更多自动化测试，为后续继续迭代提供保护。
- 版本号：`1.6.0+13`。

## v1.5.8

## 2026-05-23
- 优化页面切换和底部导航动画，减少卡顿和掉帧感。
- 全应用底部提示样式统一升级，会跟随当前主题显示，观感更一致。
- 智慧工大登录状态失效时，提示里新增“重新登录”按钮，可以直接重新登录后继续使用。
- 优化课表、饮水、水控、电费、评教、登录等功能里的提示文案和反馈状态。
- 修复部分权限提醒、外部链接打开失败等提示样式老旧的问题。
